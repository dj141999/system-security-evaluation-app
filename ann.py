"""In this version(SmartAM1), we train and test on origonal samples,  
for validation, we use unseen batch of adversarial samples"""
...
plt.figure(1)
plt.plot([0, 1], [0, 1], 'k--')
plt.plot(fpr_org, tpr_org, label='Original samples (area = {:.3f})'.format(auc_org))
